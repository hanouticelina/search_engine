...
class IndexerSimple:
    ...
    def compute_tf_idf(self):
        """
        Construit le dictionnaire tf-idf, qui associe à chaque document un dictionnaire qui lui-même associe, pour chaque token
        qui apparait dans le document, son tf-idf.
        """
    ...
    def getTfIDFsForDoc(self,doc):
        """
         Retourne la repr´esentation (stem-TFIDF) d’un document a partir de l’index
         Args:
            doc : Document considéré.
        """
        try:
